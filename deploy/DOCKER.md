...
docker run -d \
  ...
  ghcr.io/carterleealt/sub2api:latest
```
...
services:
  sub2api:
    image: ghcr.io/carterleealt/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/CarterLeeAlt/sub2api)
- [Documentation](https://github.com/CarterLeeAlt/sub2api#readme)
